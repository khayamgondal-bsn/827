...
{
       0,    29,    29,    32,    36,    37,    40,    41,    44,    45,
      48,    49,    52,    53,    56,    57,    60,    64,    65,    68,
     ...
     273,   274,   275,   276,   279,   281,   285,   287,   290,   292,
     296,   298,   302,   303,   306,   307,   310,   311,   314,   315,
     ...
     580,   581,   584,   585,   588,   589,   592,   593,   596,   598,
     602,   603,   606,   607,   610,   612,   616,   618,   622,   623,
     626,   627,   630,   631
};
#endif
...
#line 61 "parse.y" /* yacc.c:1646  */
    { std::cout<<(yyvsp[-3])<<std::endl; std::cout<<(yylsp[-4]).first_line<<std::endl; }
